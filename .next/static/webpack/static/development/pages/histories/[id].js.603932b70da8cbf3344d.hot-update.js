...
var history = function history() {
  ...
  if (histories.length == null) {
    ...
    var rocketHistory = filterHistory.filter(function (history) {
      setHistories(history.flight.rocket.rocket.id == "".concat(id));
    });
    console.log(rocketHistory); // setHistories(rocketHistory)
  }
...
//# sourceMappingURL=[id].js.603932b70da8cbf3344d.hot-update.js.map